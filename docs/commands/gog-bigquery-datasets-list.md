...
```bash
gog bigquery (bq) datasets list (ls) [flags]
```

## Parent

- [gog bigquery datasets](gog-bigquery-datasets.md)
...
| `--fail-empty`<br>`--non-empty`<br>`--require-results` | `bool` |  | Exit with code 3 if no datasets |
